...
it('Should show errors', async () => {
    await act(async () => {
        store.dispatch(updateErrors(new Map<string, string[]>([['email', ['is invalid']], ['password', ['is empty']]])));
    });
...
it('Should disable fields during update and enabled afterwards with errors', async () => {
    mockedUpdateSettings.mockResolvedValueOnce(Err(new Map<string, string[]>([['email', ['is invalid']], ['password', ['is empty']]])));
